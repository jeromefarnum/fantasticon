...
const generator = {
    generate: ({ name, codepoints, assets, formatOptions: { ts } = {} }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const codepointsName = ts.constantName || `${(0, change_case_1.constantCase)(name)}_CODEPOINTS`;
        const literalIdName = ts.literalId || `${(0, change_case_1.pascalCase)(name)}Id`;
        const literalKeyName = ts.literalKey || `${(0, change_case_1.pascalCase)(name)}Key`;
